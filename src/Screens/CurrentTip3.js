...
const CurrentTip3 = (props) => {
  ...
  let endUnloadingApiUrl = URL("Trips_Ben/6155eed0434cc01d843d1fe0/end_unload");
  ...
  const SubmitUpdateEndUnloading = async () => {
    // const params = {
    //   Start_Load_Time: Date.now(),
    // };
    const params = {
      "End_Unload-time": momentTimezone().tz("America/New_York").format(),
    };
    setLoading(true);
    const responseData = await Patch(endUnloadingApiUrl, params, apiHeader);
